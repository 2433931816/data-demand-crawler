...
本项目实现了对 **尚数网、北京、上海、广州、杭州、深圳、山东、湖南、郑州、贵阳、华东江苏、福建、安徽** 等全国主要数据交易平台的数据需求/数据产品的每日自动抓取、清洗、存储与可视化展示。
...
| 3 | 上海数据交易所 | ✅ 稳定 | API + Cookie | ~3882 条 |
| 4 | 广州数据交易所 | ✅ 稳定 | API + Token | ~39 条 |
| 5 | 杭州数据交易所 | ✅ 稳定 | API + Cookie | ~23 条 |
| 6 | 山东数据交易平台 | ✅ 稳定 | API + Cookie | ~16 条 |
| 7 | 湖南大数据交易所 | ✅ 稳定 | API + Cookie + Token | ~2703 条 |
| 8 | 郑州数据交易中心 | ✅ 稳定 | API + Cookie | ~10 条 |
| 9 | 贵阳大数据交易所 | ✅ 稳定 | API + Cookie | ~20 条 |
| 10 | 华东江苏大数据交易中心 | ⚠️ 部分接入 | API + Cookie | ~50 条（共62条，分页限制） |
| 11 | 福建大数据交易所 | ✅ 已接入 | API + Cookie | 需求广场暂无数据 |
| 12 | 安徽数据交易所 | ✅ 稳定 | API + Cookie | ~11 条 |
| 13 | 深圳数据交易所 | ⏳ 待审核 | API + Cookie | 等待企业认证 |
